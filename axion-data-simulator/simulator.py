...
API_URL = os.getenv("API_URL", "http://ingestion-svc.akkc.svc.cluster.local:80/api/v1/telemetry/ingest")
# API_URL = os.getenv("API_URL", "http://ingest.theakkc.space/api/v1/telemetry/ingest")
